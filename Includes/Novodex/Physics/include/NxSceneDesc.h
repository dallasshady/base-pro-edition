...
to accelerate scene-level collision queries (e.g. raycasting).
*/
...
class NxSceneDesc
	...
	NxBounds3*				maxBounds;			//!< Max scene bounds, if available. See notes above.
	...
	void*					userData;			//!< Will be copied to NxScene::userData
