...
void Jumper::Tracking::initPoses() {
	...
	APturnsanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,-1.0f,0.0f);
	APturnsanim->torque = PxVec3(0, 100.0f, 0);
	APturnsanim->var_c = 2;
	...
	APtrackinganim->airfoils[POSEANIM_JOINT_LLEG] = PxVec3( 0.0f,0.0f,-0.1f);
	APtrackinganim->airfoils[POSEANIM_JOINT_RLEG] = PxVec3( 0.0f,0.0f,-0.1f);
	//APtrackinganim->airfoils[POSEANIM_JOINT_TORSO] = PxVec3(0.0f, -1.5f, -1.0f);
	//if (useWingsuit) {	
	...
	APtrackingpitchanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3( 0.0f,0.0f,-2.5f);
	APtrackingpitchanim->airfoils[POSEANIM_JOINT_RARM] = PxVec3( 0.0f,0.0f,-2.5f);
	...
	APtrackingpitchanim->next = APfwdanim;
		...
		// forward/backward
	APfwdanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,-0.2f);
	APfwdanim->airfoils[POSEANIM_JOINT_RARM] = PxVec3(0.0f,0.0f,-0.2f);
	APfwdanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	APfwdanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,1.0f,0.0f);
	...
	APfwdanim->force = PxVec3(0.0f, 0.0f, 100.0f);
		// levelling
			// arms
	APleveling->airfoils[POSEANIM_JOINT_LARM] = PxVec3(-0.1f,-0.4f, 0.1f);
	APleveling->airfoils[POSEANIM_JOINT_RARM] = PxVec3( 0.1f,-0.4f, 0.1f);
	APleveling->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(1.0f,0.0f,0.0f);
	APleveling->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(1.0f,0.0f,0.0f);
	...
	APleveling->airfoils_area[POSEANIM_JOINT_RARM] = 0.2f * 0.15f;
			// legs
	APleveling->airfoils[POSEANIM_JOINT_LLEG] = PxVec3(-0.1f,-0.4f, 0.1f);
	APleveling->airfoils[POSEANIM_JOINT_RLEG] = PxVec3( 0.1f,-0.4f, 0.1f);
	APleveling->airfoils_area[POSEANIM_JOINT_LLEG] = 0.2f * 0.15f;
	APleveling->airfoils_area[POSEANIM_JOINT_RLEG] = 0.2f * 0.15f;
	APleveling->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,1.0f);
	APleveling->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,1.0f);
	APleveling->jointangles[POSEANIM_JOINT_LLEG] = -30.0f;
	APleveling->jointangles[POSEANIM_JOINT_RLEG] = -30.0f;

			// torso
	APleveling->airfoils[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,-0.1f, 0.0f);
	...
	APtrackingleveling->only_if_not_zero = &spine->modifier;
		// arms
	APtrackingleveling->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,1.0f);
	APtrackingleveling->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,1.0f,1.0f);
	...
	AProllrightanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(2.0f, 0.0f, 0.0f);
	AProllrightanim->airfoils[POSEANIM_JOINT_RARM] = PxVec3(2.3f, 0.0f, 0.0f);
			// legs
	...
	APpitchfwd->airfoils[POSEANIM_JOINT_TORSO]  = PxVec3(0.0f, 0.0f, -3.0f);
			// params	
	APpitchfwd->var_c = 2;
	...
	APpitchfwd->dReaction = -0.7f;
		...
		// pitch backward
			// torso
	APpitchback->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	APpitchback->jointangles[POSEANIM_JOINT_TORSO] = 30.0f;
	APpitchback->airfoils[POSEANIM_JOINT_TORSO]  = PxVec3(0.0f, 0.0f, 3.0f);
			// params	
	APpitchback->var_c = 2;
	...
	// head
	HeaddownPose.airfoils[POSEANIM_JOINT_HEAD]		= PxVec3(0.0f, 0.0f, 0.0f);	
	HeaddownPose.airfoils_area[POSEANIM_JOINT_HEAD] = headdown_pose_area*0.0f;
	// torso (stabilizer)
	HeaddownPose.airfoils[POSEANIM_JOINT_TORSO]		= PxVec3(0.0f, 0.0f, 0.6f);
	HeaddownPose.airfoils_area[POSEANIM_JOINT_TORSO] = headdown_pose_area*0.4f;
	// arms
	HeaddownPose.airfoils[POSEANIM_JOINT_LARM]		= PxVec3(-0.22777f, 0.0f, -2.00000f);
	HeaddownPose.airfoils_area[POSEANIM_JOINT_LARM] = headdown_pose_area*0.15f;
	HeaddownPose.airfoils[POSEANIM_JOINT_RARM]		= PxVec3( 0.22777f, 0.0f, -2.00000f);
	HeaddownPose.airfoils_area[POSEANIM_JOINT_RARM] = headdown_pose_area*0.15f;
	// legs
	HeaddownPose.airfoils[POSEANIM_JOINT_LLEG]		= PxVec3(-0.22777f, 0.0f,-6.00000f);
	HeaddownPose.jointaxis[POSEANIM_JOINT_LLEG]		= PxVec3(0.0f,0.0f,1.0f);
	...
	HeaddownPose.airfoils[POSEANIM_JOINT_RLEG]		= PxVec3( 0.22777f, 0.0f,-6.00000f);
	HeaddownPose.airfoils_area[POSEANIM_JOINT_RLEG] = headdown_pose_area*0.15f;
	HeaddownPose.jointaxis[POSEANIM_JOINT_RLEG]		= PxVec3(0.0f,0.0f,1.0f);
	HeaddownPose.jointangles[POSEANIM_JOINT_RLEG]	= -22.0f;
	// head
	HeaddownPose.jointaxis[POSEANIM_JOINT_HEAD]		= PxVec3(0.0f,0.0f,0.1f);
	HeaddownPose.jointangles[POSEANIM_JOINT_HEAD]	= 15.0f;
	// arms
	HeaddownPose.jointangles[POSEANIM_JOINT_LARM]	= 20.0f;
	HeaddownPose.jointaxis[POSEANIM_JOINT_LARM]		= PxVec3(0.0f,0.5f,0.5f);
	HeaddownPose.jointangles[POSEANIM_JOINT_RARM]	= 20.0f;
	HeaddownPose.jointaxis[POSEANIM_JOINT_RARM]		= PxVec3(0.0f,0.0f,1.0f);
	...
	HDturnsanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,1.0f);
	HDturnsanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	HDturnsanim->jointangles[POSEANIM_JOINT_RARM] = -20.0f;
	HDturnsanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,0.0f,1.0f);
	HDturnsanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,-1.0f,0.0f);
	HDturnsanim->torque = PxVec3(0, 0, 40.0f);
	HDturnsanim->var_c = 2;
	...
	HDtrackkanim->jointaxis[POSEANIM_JOINT_LLEG]	= PxVec3(0.0f,0.0f,1.0f);
	HDtrackkanim->airfoils[POSEANIM_JOINT_LLEG]		= PxVec3(0.0f,-0.9f,0.0f);
	HDtrackkanim->jointangles[POSEANIM_JOINT_RLEG]	= 15.0f;
	HDtrackkanim->jointaxis[POSEANIM_JOINT_RLEG]	= PxVec3(0.0f,0.0f,1.0f);
	HDtrackkanim->airfoils[POSEANIM_JOINT_RLEG]		= PxVec3(0.0f,-0.9f,0.0f);
	HDtrackkanim->airfoils[POSEANIM_JOINT_TORSO]	= PxVec3(0.0f,0.6f,0.0f);
	...
	HDtrackkanim->force = PxVec3(0.0f, -100.0f, 0.0f);
		// carving
	HDcarvinganim->jointangles[POSEANIM_JOINT_LLEG]	= 30.0f;
	HDcarvinganim->jointaxis[POSEANIM_JOINT_LLEG]	= PxVec3(0.0f,0.0f,1.0f);
	HDcarvinganim->airfoils[POSEANIM_JOINT_LLEG]	= PxVec3(0.0f,-0.9f,0.0f);
	HDcarvinganim->jointangles[POSEANIM_JOINT_RLEG]	= 30.0f;
	HDcarvinganim->jointaxis[POSEANIM_JOINT_RLEG]	= PxVec3(0.0f,0.0f,1.0f);
	HDcarvinganim->airfoils[POSEANIM_JOINT_RLEG]	= PxVec3(0.0f,-0.9f,0.0f);
	HDcarvinganim->airfoils[POSEANIM_JOINT_TORSO]	= PxVec3(0.0f,0.6f,0.0f);
	...
	HDcarvingSidewaysanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,1.0f);
	HDcarvingSidewaysanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	HDcarvingSidewaysanim->jointangles[POSEANIM_JOINT_RARM] = -20.0f;
	HDcarvingSidewaysanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,0.0f,1.0f);
	HDcarvingSidewaysanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,-1.0f,0.0f);
	HDcarvingSidewaysanim->torque = PxVec3(0, 0, 40.0f);
	HDcarvingSidewaysanim->force = PxVec3(800.0f, 0.0f, 0.0f);
	...
	HDcarvingForwardanim->jointaxis[POSEANIM_JOINT_LKNEE] = PxVec3(0.0f,0.0f,1.0f);
	HDcarvingForwardanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	HDcarvingForwardanim->jointangles[POSEANIM_JOINT_RKNEE] = -20.0f;
	HDcarvingForwardanim->jointaxis[POSEANIM_JOINT_RKNEE] = PxVec3(0.0f,0.0f,1.0f);
	HDcarvingForwardanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,-1.0f,0.0f);
	HDcarvingForwardanim->force = PxVec3(600.0f, 0.0f, 0.0f);
	HDcarvingForwardanim->torque = PxVec3(0, 0, -40.0f);
	...
	HDlevelinganim->next = NULL;
		// arms
	HDlevelinganim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,1.0f);
	HDlevelinganim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,1.0f,1.0f);
	HDlevelinganim->jointangles[POSEANIM_JOINT_LARM] = -20.0f;
	HDlevelinganim->jointangles[POSEANIM_JOINT_RARM] = -12.0f;
	HDlevelinganim->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,1.0f,0.0f);
	HDlevelinganim->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,1.0f,0.0f);
	...
	// head
	SitflyPose.airfoils[POSEANIM_JOINT_HEAD]		= PxVec3(0.0f, 0.0f, 0.0f);	
	SitflyPose.airfoils_area[POSEANIM_JOINT_HEAD] = sitfly_pose_area*0.0f;
	// torso (stabilizer)
	SitflyPose.airfoils[POSEANIM_JOINT_TORSO]		= PxVec3(0.0f, 0.0f, 2.0f);
	SitflyPose.airfoils_area[POSEANIM_JOINT_TORSO]  = sitfly_pose_area*0.4f;
	SitflyPose.jointaxis[POSEANIM_JOINT_TORSO]      = PxVec3(0.0f,0.0f,1.0f);
	SitflyPose.jointangles[POSEANIM_JOINT_TORSO]    = -23.0f;
	// arms
	SitflyPose.airfoils[POSEANIM_JOINT_LARM]		= PxVec3(-0.22777f, 0.0f, 10.00000f);
	SitflyPose.airfoils_area[POSEANIM_JOINT_LARM] = sitfly_pose_area*0.15f;
	SitflyPose.airfoils[POSEANIM_JOINT_RARM]		= PxVec3( 0.22777f, 0.0f, 10.00000f);
	SitflyPose.airfoils_area[POSEANIM_JOINT_RARM] = sitfly_pose_area*0.15f;
	// legs
	SitflyPose.airfoils[POSEANIM_JOINT_LLEG]		= PxVec3(-0.22777f, 0.0f,-10.00000f);
	//SitflyPose.jointaxis[POSEANIM_JOINT_LLEG]		= PxVec3(0.0f,0.0f,1.0f);
	//SitflyPose.jointangles[POSEANIM_JOINT_LLEG]	= -22.0f;
	SitflyPose.airfoils_area[POSEANIM_JOINT_LLEG] = sitfly_pose_area*0.15f;
	SitflyPose.airfoils[POSEANIM_JOINT_RLEG]		= PxVec3( 0.22777f, 0.0f,-10.00000f);
	...
	PoseAnim *SFpitchback = new PoseAnim();
		...
		// turns
			// legs
	SFturnsanim->airfoils[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,-0.13f);
	SFturnsanim->airfoils[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,-0.13f);
	SFturnsanim->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	SFturnsanim->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	...
	SFturnsanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,1.0f);
	SFturnsanim->jointangles[POSEANIM_JOINT_RARM] = -13.0f;
	SFturnsanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,0.0f,1.0f);
			// forces
	SFturnsanim->torque = PxVec3(0, 0, 40.0f);
			// params
	SFturnsanim->var_c = 2;
	...
	SitflyPose.anims = *SFturnsanim;
		...
		// forward/backward
			// arms
	SFfwdanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,1.0f);
	SFfwdanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,0.0f,1.0f);
	SFfwdanim->jointangles[POSEANIM_JOINT_LARM] = 13.0f;
	SFfwdanim->jointangles[POSEANIM_JOINT_RARM] = 13.0f;
			// legs
	SFfwdanim->airfoils[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.1f,0.0f);
	SFfwdanim->airfoils[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.1f,0.0f);
	SFfwdanim->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,1.0f);
	SFfwdanim->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,1.0f);
	SFfwdanim->jointangles[POSEANIM_JOINT_LLEG] = 23.0f;
	SFfwdanim->jointangles[POSEANIM_JOINT_RLEG] = 23.0f;
			// torso
	SFfwdanim->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	SFfwdanim->jointangles[POSEANIM_JOINT_TORSO] = -10.0f;
	SFfwdanim->airfoils[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.08f,0.0f);
			// forces
	SFfwdanim->force = PxVec3(0.0f, -140.0f, 0.0f);
	...
	SFfwdanim->next = SFleveling_lower;
		...
		// levelling lower
			// arms
	SFleveling_lower->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(1.0f,-1.0f,0.0f);
	SFleveling_lower->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(1.0f,-1.0f,0.0f);
	SFleveling_lower->jointangles[POSEANIM_JOINT_LARM] = 55.0f;
	SFleveling_lower->jointangles[POSEANIM_JOINT_RARM] = 55.0f;
			// legs
	tmp = PxVec3(-1.0f,0.0f,1.0f);
	tmp.normalize();
	SFleveling_lower->jointaxis[POSEANIM_JOINT_LLEG] = tmp;
	tmp = PxVec3(1.2f,0.0f,1.0f);
	tmp.normalize();
	...
	SFleveling_lower->jointangles[POSEANIM_JOINT_RLEG] = 48.0f;
			...
			// torso
	SFleveling_lower->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	...
	SFleveling_lower->next = SFleveling_higher;
		...
		// levelling higher
			// arms
	SFleveling_higher->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,-1.0f);
	SFleveling_higher->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,0.0f,-1.0f);
	...
	SFleveling_higher->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	...
	// head
	BackflyPose.airfoils[POSEANIM_JOINT_HEAD]		= PxVec3(0.0f, 0.0f, 1.0f);	
	BackflyPose.airfoils_area[POSEANIM_JOINT_HEAD] = backfly_pose_area*0.0f;
	// torso (stabilizer)
	BackflyPose.airfoils[POSEANIM_JOINT_TORSO]		= PxVec3(0.0f, -0.5f, 0.0f);
	BackflyPose.airfoils_area[POSEANIM_JOINT_TORSO] = backfly_pose_area*0.4f;
	BackflyPose.jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f, 0.0f, 1.0f);
	BackflyPose.jointangles[POSEANIM_JOINT_TORSO] = -15.0f;
	// arms
	BackflyPose.airfoils[POSEANIM_JOINT_LARM]		= PxVec3(-2.22777f, -0.52505f, 10.00000f);
	BackflyPose.airfoils_area[POSEANIM_JOINT_LARM] = backfly_pose_area*0.15f;
	BackflyPose.airfoils[POSEANIM_JOINT_RARM]		= PxVec3( 2.22777f, -0.52505f, 10.00000f);
	BackflyPose.airfoils_area[POSEANIM_JOINT_RARM] = backfly_pose_area*0.15f;
	tmp = PxVec3(0.0f, 0.5f, -0.7f);
	tmp.normalize();
	...
	// legs
	BackflyPose.airfoils[POSEANIM_JOINT_LLEG]		= PxVec3(-2.22777f, -0.52505f,-10.00000f);
	BackflyPose.airfoils_area[POSEANIM_JOINT_LLEG] = backfly_pose_area*0.15f;
	BackflyPose.airfoils[POSEANIM_JOINT_RLEG]		= PxVec3( 2.22777f, -0.52505f,-10.00000f);
	...
	PoseAnim *BFrollleftanim = new PoseAnim();
		...
		// turns
			// legs
	BFturnsanim->airfoils[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,-0.13f);
	BFturnsanim->airfoils[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,-0.13f);
	BFturnsanim->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,1.0f);
	BFturnsanim->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,1.0f);
	BFturnsanim->jointangles[POSEANIM_JOINT_LLEG] = 13.0f;
	BFturnsanim->jointangles[POSEANIM_JOINT_RLEG] = -13.0f;
			// forces
	BFturnsanim->torque = PxVec3(0, -100.0f, 0);
			// params
	BFturnsanim->var_c = 2;
	...
	BFturnsanim->next = BFtrackinganim;
		...
		// tracking
	BFtrackinganim->airfoils[POSEANIM_JOINT_LARM] = PxVec3( 0.0f,0.0f,-1.5f);
	BFtrackinganim->airfoils[POSEANIM_JOINT_RARM] = PxVec3( 0.0f,0.0f,-1.5f);
	BFtrackinganim->airfoils[POSEANIM_JOINT_LLEG] = PxVec3( 0.0f,0.0f,-0.1f);
	BFtrackinganim->airfoils[POSEANIM_JOINT_RLEG] = PxVec3( 0.0f,0.0f,-0.1f);
	BFtrackinganim->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f, 0.0f, 1.0f);
	...
	BFtrackinganim->next = BFfwdanim;
		...
		// forward/backward
			// legs
	BFfwdanim->airfoils[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,-0.2f);
	BFfwdanim->airfoils[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,-0.2f);
	BFfwdanim->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,1.0f);
	BFfwdanim->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,1.0f);
	BFfwdanim->jointangles[POSEANIM_JOINT_LLEG] = 30.0f;
	BFfwdanim->jointangles[POSEANIM_JOINT_RLEG] = 30.0f;
			// knees
	BFfwdanim->jointaxis[POSEANIM_JOINT_LKNEE] = PxVec3(0.0f,0.0f,1.0f);
	BFfwdanim->jointaxis[POSEANIM_JOINT_RKNEE] = PxVec3(0.0f,0.0f,1.0f);
	BFfwdanim->jointangles[POSEANIM_JOINT_LKNEE] = 5.0f;
	BFfwdanim->jointangles[POSEANIM_JOINT_RKNEE] = 5.0f;
			// arms
	BFfwdanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,-0.2f);
	BFfwdanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(0.0f,0.0f,-0.2f);
	BFfwdanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	BFfwdanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,1.0f,0.0f);
	...
	BFfwdanim->force = PxVec3(0.0f, 0.0f, 100.0f);

		// levelling
			// arms
	BFleveling->airfoils[POSEANIM_JOINT_LARM] = PxVec3(-0.1f,-0.4f, 0.1f);
	BFleveling->airfoils[POSEANIM_JOINT_RARM] = PxVec3( 0.1f,-0.4f, 0.1f);
	BFleveling->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(1.0f,0.0f,0.0f);
	BFleveling->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(1.0f,0.0f,0.0f);
	...
	BFleveling->airfoils_area[POSEANIM_JOINT_RARM] = 0.2f * 0.15f;
			// legs
	BFleveling->airfoils[POSEANIM_JOINT_LLEG] = PxVec3(-0.1f,-0.4f,-0.1f);
	BFleveling->airfoils[POSEANIM_JOINT_RLEG] = PxVec3( 0.1f,-0.4f,-0.1f);
	BFleveling->airfoils_area[POSEANIM_JOINT_LLEG] = 0.2f * 0.15f;
	BFleveling->airfoils_area[POSEANIM_JOINT_RLEG] = 0.2f * 0.15f;
	BFleveling->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,0.0f,1.0f);
	BFleveling->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,0.0f,1.0f);
	BFleveling->jointangles[POSEANIM_JOINT_LLEG] = 30.0f;
	BFleveling->jointangles[POSEANIM_JOINT_RLEG] = 30.0f;
			// torso
	BFleveling->airfoils[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.2f, 0.0f);
	...
	// roll left
			// arms
	BFrollleftanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	BFrollleftanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,1.0f,0.0f);
	BFrollleftanim->jointangles[POSEANIM_JOINT_LARM] = 50.0f;
	BFrollleftanim->jointangles[POSEANIM_JOINT_RARM] = -40.0f;
	BFrollleftanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(2.3f, 0.0f, 0.0f);
	BFrollleftanim->airfoils[POSEANIM_JOINT_RARM] = PxVec3(2.0f, 0.0f, 0.0f);
			// legs
	BFrollleftanim->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,1.0f,0.0f);
	BFrollleftanim->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,1.0f,0.0f);
	BFrollleftanim->jointangles[POSEANIM_JOINT_LLEG] = -22.0f;
	BFrollleftanim->jointangles[POSEANIM_JOINT_RLEG] = 22.0f;
			// torso
	BFrollleftanim->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	BFrollleftanim->jointangles[POSEANIM_JOINT_TORSO] = 8.0f;
			// forces
	BFrollleftanim->torque = PxVec3(0.0f, 0.0f, -900.0f);
	...
	BFrollleftanim->next = BFrollrightanim;
		// roll right
			// arms
	BFrollrightanim->jointaxis[POSEANIM_JOINT_LARM] = PxVec3(0.0f,1.0f,0.0f);
	BFrollrightanim->jointaxis[POSEANIM_JOINT_RARM] = PxVec3(0.0f,1.0f,0.0f);
	BFrollrightanim->jointangles[POSEANIM_JOINT_LARM] = 50.0f;
	BFrollrightanim->jointangles[POSEANIM_JOINT_RARM] = -40.0f;
	BFrollrightanim->airfoils[POSEANIM_JOINT_LARM] = PxVec3(2.0f, 0.0f, 0.0f);
	BFrollrightanim->airfoils[POSEANIM_JOINT_RARM] = PxVec3(2.3f, 0.0f, 0.0f);
			// legs
	BFrollrightanim->jointaxis[POSEANIM_JOINT_LLEG] = PxVec3(0.0f,1.0f,0.0f);
	BFrollrightanim->jointaxis[POSEANIM_JOINT_RLEG] = PxVec3(0.0f,1.0f,0.0f);
	BFrollrightanim->jointangles[POSEANIM_JOINT_LLEG] = -22.0f;
	BFrollrightanim->jointangles[POSEANIM_JOINT_RLEG] = 22.0f;
			// torso
	BFrollrightanim->jointaxis[POSEANIM_JOINT_TORSO] = PxVec3(0.0f,0.0f,1.0f);
	BFrollrightanim->jointangles[POSEANIM_JOINT_TORSO] = 8.0f;
			// forces
	BFrollrightanim->torque = PxVec3(0.0f, 0.0f, 900.0f);
