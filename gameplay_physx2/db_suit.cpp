...
#define PROPERTIES_ALTITUDE_CRASH_TEST_DIVER    0.0625f, 1.0f, 1.0f,   1.0f, 1.0f,   1.0f,   1.0f,  1.0f, 0.0f
...
static Suit suits[] = 
{
    ...
    /* 028 */ { true, 0.0f, false, 0, MODELID_FB_SUIT, DESCRIPTION_FB_SUIT, CLID_WHITE, MFRID_D3, 70, PROPERTIES_FB_SUIT },


	/* 029 */ { true, COST_ALTITUDE_CRASH_TEST_DIVER, false, 0, MODELID_CRASH_TEST_DIVER, DESCRIPTION_ALTITUDE_CRASH_TEST_DIVER, CLID_CTD, CLID_CTD, 71, PROPERTIES_ALTITUDE_CRASH_TEST_DIVER },
    { 0.0f, 0,0,0,0 }
};
