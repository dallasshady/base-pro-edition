...
void Jumper::Tracking::initPosesWings() {
	...
	ArchPose.jointaxis[POSEANIM_JOINT_LARM]		= NxVec3(0.0f, 1.0f, 1.0f);
	...
	ArchPose.jointaxis[POSEANIM_JOINT_RARM]		= NxVec3(0.0f, 0.0f, 1.0f);
	...
	ArchPose.jointaxis[POSEANIM_JOINT_LLEG]		= NxVec3(0.0f,0.0f,1.0f);
	ArchPose.jointangles[POSEANIM_JOINT_LLEG]	= -12.0f;
	ArchPose.jointaxis[POSEANIM_JOINT_RLEG]		= NxVec3(0.0f,0.0f,1.0f);
	...
	//APturnsanim->jointaxis[POSEANIM_JOINT_TORSO] = NxVec3(1.0f,0.0f,0.0f);
	...
	APturnsanim->jointangles[POSEANIM_JOINT_RARM] = -20.0f;
			...
			// forces
	APturnsanim->torque = NxVec3(0, 230.0f, 0);
			// params
	APturnsanim->var_c = 2;
	...
	APturnsanim->next = APspdbreakanim;
		...
		// speed braking
			// leg wing
	APspdbreakanim->jointaxis[POSEANIM_JOINT_LLEG]	= NxVec3(0.0f,0.0f,1.0f);
	APspdbreakanim->jointangles[POSEANIM_JOINT_LLEG]	= 20.0f;
	APspdbreakanim->jointaxis[POSEANIM_JOINT_RLEG]	= NxVec3(0.0f,0.0f,1.0f);
	APspdbreakanim->jointangles[POSEANIM_JOINT_RLEG]	= 20.0f;
	//APspdbreakanim->airfoils_area[POSEANIM_JOINT_TORSO] = 0.08f;
	APspdbreakanim->force = NxVec3(0.0f, 0.0f, -80.0f);
	...
	APspdbreakanim->next = APleveling_higher;
		...
		// levelling
			// arms
	//APleveling_higher->jointaxis[POSEANIM_JOINT_LARM] = NxVec3(0.0f,0.0f,1.0f);
	//APleveling_higher->jointaxis[POSEANIM_JOINT_RARM] = NxVec3(0.0f,0.0f,1.0f);
	//APleveling_higher->jointangles[POSEANIM_JOINT_LARM] = 20.0f;
	//APleveling_higher->jointangles[POSEANIM_JOINT_RARM] = 20.0f;
			// torso
	//APleveling_higher->airfoils[POSEANIM_JOINT_TORSO] = NxVec3(0.0f,-1.0f, 0.0f);
	//APleveling_higher->airfoils_area[POSEANIM_JOINT_TORSO] = 0.2f * 0.4f;
			// forces
	APleveling_higher->force = NxVec3(0.0f, 80.0f, 0.0f);
			// params
	...
	APtrackinganim->airfoils[POSEANIM_JOINT_LLEG] = NxVec3( 0.0f,0.0f,-0.5f);
	APtrackinganim->airfoils[POSEANIM_JOINT_RLEG] = NxVec3( 0.0f,0.0f,-0.5f);
	APtrackinganim->airfoils[POSEANIM_JOINT_TORSO] = NxVec3(0.0f, 0.4f, -1.8f);
	...
	AProllrightanim->airfoils[POSEANIM_JOINT_LARM] = NxVec3(2.3f, 0.0f, 0.0f);
	AProllrightanim->airfoils[POSEANIM_JOINT_RARM] = NxVec3(2.0f, 0.0f, 0.0f);
			// legs
	...
	APtrackingpitchanim->airfoils[POSEANIM_JOINT_LARM] = NxVec3( 0.0f,0.0f,-3.5f);
	APtrackingpitchanim->airfoils[POSEANIM_JOINT_RARM] = NxVec3( 0.0f,0.0f,-3.5f);
		APtrackingpitchanim->airfoils[POSEANIM_JOINT_LARM] = NxVec3( 0.0f,0.0f,-4.5f);
		APtrackingpitchanim->airfoils[POSEANIM_JOINT_RARM] = NxVec3( 0.0f,0.0f,-4.5f);
	...
	APtrackingpitchanim->airfoils[POSEANIM_JOINT_RLEG] = NxVec3( 0.0f,0.0f,-0.1f);
		APtrackingpitchanim->airfoils[POSEANIM_JOINT_LLEG] = NxVec3( 0.0f,0.0f,-0.5f);
		APtrackingpitchanim->airfoils[POSEANIM_JOINT_RLEG] = NxVec3( 0.0f,0.0f,-0.5f);
	...
	APtrackingpitchanim->jointaxis[POSEANIM_JOINT_LARM] = NxVec3(0.0f,0.0f,1.0f);
	APtrackingpitchanim->jointaxis[POSEANIM_JOINT_RARM] = NxVec3(0.0f,0.0f,1.0f);
	...
	APtrackingpitchanim->dL = 0.2f;
		// pitch forward
			// torso
	APpitchfwd->airfoils[POSEANIM_JOINT_LARM] = NxVec3( 0.0f,0.0f,-6.5f);
	APpitchfwd->airfoils[POSEANIM_JOINT_RARM] = NxVec3( 0.0f,0.0f,-6.5f);
	APpitchfwd->airfoils[POSEANIM_JOINT_LLEG] = NxVec3( 0.0f,0.0f,-1.7f);
	APpitchfwd->airfoils[POSEANIM_JOINT_RLEG] = NxVec3( 0.0f,0.0f,-1.7f);
	APpitchfwd->jointangles[POSEANIM_JOINT_TORSO] = 15.0f;
	APpitchfwd->jointaxis[POSEANIM_JOINT_TORSO] = NxVec3(0.0f,0.0f,1.0f);
			// forces
	APpitchfwd->torque = NxVec3(1300.0f, 0.0f, 0.0f);
			// params
	APpitchfwd->var_c = 2;
	...
	APpitchfwd->next = APwingareaanim;
		...
		// wing area (only negative is used!)
			// arms
	APwingareaanim->jointaxis[POSEANIM_JOINT_LARM] = NxVec3(0.0f, 1.0f, 0.0f);
	...
	APwingareaanim->jointaxis[POSEANIM_JOINT_RARM] = NxVec3(0.0f, 1.0f, 0.0f);
	...
	//		// legs
	APwingareaanim->jointaxis[POSEANIM_JOINT_LLEG] = NxVec3(0.0f, 1.0f, 0.0f);
	APwingareaanim->jointangles[POSEANIM_JOINT_LLEG] = 6.0f;
	APwingareaanim->airfoils_area[POSEANIM_JOINT_LLEG] = arch_pose_area * 0.01f;
	APwingareaanim->jointaxis[POSEANIM_JOINT_RLEG] = NxVec3(0.0f, 1.0f, 0.0f);
	...
	//APwingareaanim->dReaction = 0.2f;
		...
		// pitch backward
			// torso
	//APpitchback->airfoils[POSEANIM_JOINT_LARM] = NxVec3( 0.0f,0.0f, 1.5f);
	//APpitchback->airfoils[POSEANIM_JOINT_RARM] = NxVec3( 0.0f,0.0f, 1.5f);
	//APpitchback->airfoils[POSEANIM_JOINT_LLEG] = NxVec3( 0.0f,0.0f, 0.09f);
	//APpitchback->airfoils[POSEANIM_JOINT_RLEG] = NxVec3( 0.0f,0.0f, 0.09f);
			// params	
	APpitchback->var_c = 1;
